lines = [
    ...
    "Exeunt",
    "SCENE III  A room in Capulets house",
    ...
    "First Servant",
    "Wheres Potpan  that he helps not to take away  He",
    ...
    "Exit",
    "SCENE I  A lane by the wall of Capulets orchard",
    "Enter ROMEO",
    "ROMEO",
    ...
    "Exit",
    "SCENE III  Friar Laurences cell",
    ...
    "blind bow boys butt shaft  and is he a man to",
    "encounter Tybalt",
    "BENVOLIO",
    "Why  what is Tybalt",
    "MERCUTIO",
    ...
    "perdona mis  who stand so much on the new form",
    ...
    "TYBALT under ROMEOs arm stabs MERCUTIO  and flies with his followers",
    "MERCUTIO",
    "I am hurt",
    ...
    "ROMEO",
    "What less than dooms day is the princes doom",
    "FRIAR LAURENCE",
    ...
    "Is death mis termd  calling death banishment",
    ...
    "Second Servant",
    "You shall have none ill  sir  for Ill try if they",
    ...
    "Ill have this knot knit up to morrow morning",
    "JULIET",
    ...
    "PETER",
    "Then will I lay the serving creatures dagger on",
    ...
    "Second Musician",
    "Hang him  Jack  Come  well in here  tarry for the",
    ...
    "Banishd the new made bridegroom from the city",
